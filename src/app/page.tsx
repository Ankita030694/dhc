    ...
    <main>
      ...
      <section className="fruit-section">
        <div className="fruit-container">
          ...
          Step into Delhi House Cafe, where flavours flirt, spices tease, and Delhi's soul takes the spotlight.
          </p>
        </div>
      </section>
      ...
      >
        <div className="horizontal-slide-container">
          ...
          >
            <img src="/img1.jpg" alt="Delhi House Cafe ambiance" />
          </div>
        </div>
      </section>
      ...
      <div className="reveal-section">
        ...
        >
          <motion.div className="experience-container" variants={staggerContainerVariants}>
            ...
            >
              {splitTextIntoWords("Delhi House Cafe is more than just a restaurant; it's a journey through Delhi's vibrant streets, connecting you with the soulful essence of Indian flavours.")}
            </motion.p>
      ...
      <section className="pasta-lab-section md:mx-20">
        ...
        <div className="pasta-lab-container">
          ...
          <div className="pasta-lab-images">
            ...
            <div className="pasta-lab-image">
              <img src="/pb1.jpg" alt="Image 2" />
            </div>
            <div className="pasta-lab-image">
              <img src="/pb2.jpg" alt="Image 2" />
            </div>
          </div>
        </div>
      </section>
